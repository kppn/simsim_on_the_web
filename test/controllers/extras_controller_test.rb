...
class ExtrasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create extra" do
    assert_difference('Extra.count') do
      post extras_url, params: { extra: { content: @extra.content, name: @extra.name, scenario_id: @extra.scenario_id } }
    end
  ...
  test "should update extra" do
    patch extra_url(@extra), params: { extra: { content: @extra.content, name: @extra.name, scenario_id: @extra.scenario_id } }
